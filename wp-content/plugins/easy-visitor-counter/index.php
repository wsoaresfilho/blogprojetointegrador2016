...
class VisitorCounterPlugin_Widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        <aside class="widget" id="visitor-counter">
            <h2 class="visitor-counter-heading" style="font-family:<?php echo $headingfontfamily ?>; color:<?php echo $headingcolor ?>;" ><a href="http://visitorcounterplugin.com">Número de Visitantes</a></h2>
        <div class="visitor-counter-content" style="color: <?php echo $textcolor ?>; font-family: <?php echo $textfontfamily ?>;" >
            <p>Hoje: <?php echo vcp_get_visit_count('D') ?></p>
            <!--<p>Ontem: <?php echo vcp_get_visit_count('Y') ?></p>-->
            <p>Esta Semana: <?php echo vcp_get_visit_count('W') ?></p>
            <p>Este Mês: <?php echo vcp_get_visit_count('M') ?></p>
            <p>Total: <?php echo vcp_get_visit_count('T') ?></p>
            <p>Online: <?php echo vcp_get_visit_count('C') ?></p>
        </div>
        </aside>
